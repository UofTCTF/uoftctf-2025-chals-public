...
app.post('/search', async (req, res) => {
  const query = (req.body.query || '').trim(); // Default to an empty string if query is undefined
  const language = req.body.language || ''; // Provide a default for language if needed
